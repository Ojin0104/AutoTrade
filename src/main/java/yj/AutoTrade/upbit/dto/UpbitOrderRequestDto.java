...
public class UpbitOrderRequestDto implements UpbitRequestParamsDto {
        ...
        @JsonProperty("volume")
        private String volume; // 주문량 (지정가, 시장가 매도 시 필수, NumberString)

        @JsonProperty("price")
        private String price; // 주문 가격 (지정가, 시장가 매수 시 필수, NumberString)

        @JsonProperty("ord_type")
        private String ordType; // 주문 타입 (limit, price, market, best)
